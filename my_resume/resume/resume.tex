...
\begin{onecolentry}
      \begin{highlightsforbulletentries}
            ...
            \item \textbf{Programming Languages}: C++, C, Java, Python, C\#, HTML, JavaScript.

            \item \textbf{Softskills}: CAD Design (SolidWorksm, Inventor), PCB Design (Altium Designer, Fusion360)
            \item \textbf{Embedded Programming}: CAD Design (SolidWorks, Inventor), PCB Design (Altium Designer, Fusion360)
...
\begin{onecolentry}
      \begin{highlights}
            ...
            \item \textbf{Achivements:} \textbf{QUT Dean's Scholar}, Executive Deans' Commendation for Academic Excellence (2022-Now).
      \end{highlights}
\end{onecolentry}
